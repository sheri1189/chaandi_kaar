                ...
                <div class="row">
                    <div class="col-xxl-12">
                        <div class="breadcrumb__content p-relative z-index-1">
                            <h3 class="breadcrumb__title">{{ Str::ucfirst($category->name) }}</h3>
                                                                ...
                                                                <div class="tp-product-list-content">
                                                                    <div class="tp-product-content-2 pt-15">
                                                                        ...
                                                                        <div class="tp-product-list-add-to-cart">
                                                                            <button
                                                                                class="tp-product-list-add-to-cart-btn" data-id="{{ $product->id }}"
                                                                                id="add_to_cart"
                                                                                {{ $product_stock[$product->id] == 0 ? 'disabled' : '' }}> {{ $product_stock[$product->id] == 0 ? 'Out Of Stock' : 'Add to Cart' }}</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
