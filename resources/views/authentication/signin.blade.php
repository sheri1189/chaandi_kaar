                    ...
                    <div class="col-xl-6 col-lg-8">
                        <div class="tp-login-wrapper">
                            <div class="tp-login-top text-center mb-30">
                                ...
                                <p>Don’t have an account? <span><a href="{{ url('/register') }}">Create a free
                                            account</a></span></p>
                            </div>
                            @php
                                $email_cookie = '';
                            ...
                            <div class="tp-login-option">
                                ...
                                <div class="tp-login-input-wrapper">
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input id="email" type="email" value="{{ $email_cookie }}" placeholder="example@mail.com">
                                        </div>
                                    ...
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input id="tp_password" type="password"  value="{{ $password_cookie }}" placeholder="Enter Your Password">
                                        </div>
                                ...
                                <div class="tp-login-suggetions d-sm-flex align-items-center justify-content-between mb-20">
                                    <div class="tp-login-remember">
                                        <input id="remember" type="checkbox" {{ $checked }} value="1">
