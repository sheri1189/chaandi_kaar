                        ...
                        <div class="tp-login-wrapper">
                            <div class="tp-login-option">
                                ...
                                <div class="tp-login-mail text-center mb-40">
                                    <p>Sign in with <a href="{{ url('#') }}">Email</a></p>
                                </div>
                                <div class="tp-login-input-wrapper">
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input id="tp_password" type="password" placeholder="Enter Confirm Password">
                                        </div>
                                    ...
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input type="hidden" id="get_email" value="{{ $email }}">
                                            <input id="tp_confirm_password" type="password"
                                ...
                                <div class="tp-login-bottom">
                                    <a type="button" id="submit" class="tp-login-btn w-100">Reset Password</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            $(document).on("click", "#submit", function(stop) {
                ...
                var confirm_password = $("#tp_confirm_password").val();
                ...
                if (password != confirm_password) {
                    Swal.fire({
                        toast: true,
                        icon: "error",
                        title: "Password and the confirm password will be matched..!",
                        animation: false,
                        position: "top-right",
                        showConfirmButton: false,
                        timer: 3000,
