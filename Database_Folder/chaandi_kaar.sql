...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 03, 2024 at 10:25 PM
...
(1, 'Silver', 'Lorem ipsum Dollar', '1', '2024-09-03 15:25:21', '2024-09-03 15:25:21');
...
CREATE TABLE `users` (
  ...
  `labour_cost` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `temp_password`, `contact_no`, `address`, `is_active`, `is_admin`, `email_verified_at`, `is_email_verified`, `role`, `labour_cost`, `created_at`, `updated_at`) VALUES
(1, 'Admin', 'admin@gmail.com', '$2y$10$ExOEzz8r445dwk7cP7xpY.a292W8wrSqgtmbi0G5fQ1XE9ebyEtIe', '123123123', '0312-0000000', 'Faisalabad,Pakistan', '1', '1', '2024-09-03 20:25:21', '1', 'Admin', NULL, '2024-09-03 15:25:21', '2024-09-03 15:25:21');
